...
% For coloured image in this tutorial we used thresh value of 5,50 and500 % for generating images shown in Figs. 3(b)-(d) respectively. 
% For grayscale images in this tutorial we used thresh value of 10,60 and100 % for generating images shown in Figs. 4(b)-(d) respectively. 
...
imwrite(uint8(image_square),'original_image_colored.jpeg');imwrite(uint8(image_compressed),'Compressed_image_coloured.jpg'); 
else 
%% Computing the size of an image 
[m1,n1]=size(image); 
z=min(m1,n1); 
